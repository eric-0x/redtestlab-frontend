...
export const generateMetadata = async (): Promise<Metadata> => {
  try {
    const response = await fetch("https://redtestlab.com/api/metatags/9", { cache: 'no-store' })
    ...
    return {
      title: "Partner with RedTest Lab—Join Our Healthcare Network in Bihar",
      description: "Collaborate with RedTest Lab as a doctor, lab, or hospital. Grow your reach with our test booking platform and home collection services.",
