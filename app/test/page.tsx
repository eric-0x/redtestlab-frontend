...
export const generateMetadata = async (): Promise<Metadata> => {
  try {
    const response = await fetch("https://redtestlab.com/api/metatags/3", { cache: 'no-store' })
    ...
    return {
      title: "Find & Book Diagnostic Tests Online—RedTest Lab",
      description: "Search and book medical tests with verified labs through RedTest Lab Bihar. Compare prices, read reviews, and get reports online.",
