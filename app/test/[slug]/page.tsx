    ...
    const fetchPopularTests = async () => {
      try {
        ...
        if (response.ok) {
          ...
          // Prefer specific categories, but ensure we always have 4 items
          const preferred = data.filter((item: TestData) => item.categoryId === 1 || item.categoryId === 2)
          const popular: TestData[] = []
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">{error || "The test you're looking for doesn't exist."}</p>
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-3 space-y-4 sm:space-y-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4 text-sm sm:text-base">
                      <div className="flex items-center gap-2 bg-green-50 px-3 sm:px-4 py-2 rounded-md border border-green-200">
                        ...
                        <span className="font-semibold text-green-800">Popular Test</span>
                      </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
                  ...
                  <div className="flex items-center gap-3 p-3 sm:p-4 bg-gray-50 rounded-lg border">
                    ...
                    <div>
                      ...
                      <p className="text-sm sm:text-base text-gray-700 font-medium">{testData.reportTime} hours</p>
                    </div>
                  </div>
                      ...
                      <div className="flex items-start gap-3 sm:gap-4">
                        ...
                        <div>
                          <h3 className="font-bold text-gray-900 mb-2 sm:mb-3 text-base sm:text-lg">
                            {testData.FAQ && testData.FAQ.length > 0 
                              ? testData.FAQ[0].question 
                              : `What is ${testData.name}?`
                            }
                          </h3>
                          {testData.FAQ && testData.FAQ.length > 0 ? (
                            <p className="text-gray-800 leading-relaxed text-sm sm:text-base font-medium">
                              {testData.FAQ[0].answer}
                            </p>
                          ) : testData.overview ? (
                            <div 
                              className="text-gray-800 leading-relaxed text-sm sm:text-base font-medium prose prose-sm max-w-none"
                              dangerouslySetInnerHTML={{ __html: testData.overview }}
                            />
                          ) : (
                            <p className="text-gray-800 leading-relaxed text-sm sm:text-base font-medium">
                              {testData.description || `${testData.name} is a comprehensive test that evaluates your health and detects various conditions through blood analysis.`}
                            </p>
                          )}
                        </div>
                      </div>
                        ...
                        testData.overview ? (
                          ...
                          <>
                            <p className="leading-relaxed text-sm sm:text-base font-medium">
                              This test measures important health markers and provides crucial insights into your overall health status.
                            </p>
                            <p className="leading-relaxed text-sm sm:text-base font-medium">
            ...
            {/* FAQ */}
            {testData.FAQ && Array.isArray(testData.FAQ) && testData.FAQ.length > 0 && (
              <Card className="border-0 shadow-sm bg-white">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <Card className="border-0 shadow-lg bg-white">
              <CardContent className="p-4 sm:p-6 text-center">
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-gray-900">{testData.name}</h3>

                <div className="mb-4 sm:mb-6">
                  <div className="flex items-center justify-center gap-2 mb-2">
                    <span className="text-lg sm:text-xl text-gray-600 line-through font-medium">₹{testData.actualPrice}</span>
                    <Badge
                      variant="destructive"
                  ...
                  <div className="text-3xl sm:text-4xl font-bold text-blue-600 mb-2">₹{testData.discountedPrice}</div>
            ...
            <Card className="border-0 shadow-sm bg-blue-600 text-white">
              <CardContent className="p-4 sm:p-6 text-center">
                ...
                <p className="text-sm sm:text-base opacity-90 font-medium">on Health & Medical Tests</p>
              </CardContent>
            </Card>
