...
export const generateMetadata = async (): Promise<Metadata> => {
  try {
    const response = await fetch("https://redtestlab.com/api/metatags/8", { cache: 'no-store' })
    ...
    return {
      title: "Terms & Conditions – RedTest Lab Bihar Diagnostic Services",
      description: "Review the terms and policies for using RedTest Lab’s online healthcare platform, test bookings, doctor appointments, and home collections.",
