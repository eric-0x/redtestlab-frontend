...
export const generateMetadata = async (): Promise<Metadata> => {
  try {
    const response = await fetch("https://redtestlab.com/api/metatags/7", { cache: 'no-store' })
    ...
    return {
      title: "Help & Support – RedTest Lab Online Healthcare Services",
      description: "Need help with bookings or reports? Visit our Help & Support center to resolve queries related to RedTest Lab diagnostics and appointments.",
