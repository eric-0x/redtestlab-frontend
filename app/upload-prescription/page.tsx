...
const PrescriptionUpload: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      {showLoginToast && (
        <div className="mb-4 p-3 bg-red-50 text-red-700 rounded-lg text-sm flex items-center border border-red-200">
          <svg className="w-5 h-5 mr-2 text-red-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01M21 12c0 4.97-4.03 9-9 9s-9-4.03-9-9 4.03-9 9-9 9 4.03 9 9z" /></svg>
          <span>Please login to upload prescription</span>
        </div>
      )}
