  ...
  useEffect(() => {
    const fetchMetaTags = async () => {
      try {
        ...
        setMetaTags({
          id: 4,
          filename: "HealthPackages",
          title: "RedTest Lab - Health Packages",
          description: "Explore comprehensive health packages and medical test bundles at RedTest Lab",
          keywords: "health packages, medical tests, health checkups, test bundles, preventive care",
          charset: "utf-8",
          author: "RedTest Lab",
          canonicallink: typeof window !== "undefined" ? window.location.href : "",
          favicon: "/favicon.ico",
          opengraph: "RedTest Lab Health Packages",
          twitter: "RedTest Lab",
          schema: "",
