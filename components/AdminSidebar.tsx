...
export default function Sidebar({ sidebarOpen, setSidebarOpen, currentPath }: SidebarProps) {
  ...
  const managementSections = [
    ...
    },
    {
      ...
      mainPath: "/admin/site",
      subLinks: [
        { title: "Blog", icon: <Newspaper size={18} className="text-blue-600" />, path: "/admin/site/blog" },
        { title: "Meta Tags", icon: <Tag size={18} className="text-blue-600" />, path: "/admin/site/meta" },
        //{ title: "Doctor", icon: <UserCheck size={18} className="text-blue-600" />, path: "/admin/site/doctor" },
        { title: "Career Listing", icon: <ClipboardList size={18} className="text-blue-600" />, path: "/admin/site/career" },
        {
          title: "Career Booked",
          icon: <ClipboardList size={18} className="text-blue-600" />,
          path: "/admin/site/careerview",
        },
        { title: "User List", icon: <Users size={18} className="text-blue-600" />, path: "/admin/site/user" },
  { title: "Banner", icon: <Image size={18} className="text-blue-600" />, path: "/admin/site/banner" },
        { title: "Pincode", icon: <MapPin size={18} className="text-blue-600" />, path: "/admin/site/pincode" },
        { title: "Testimonial", icon: <Star size={18} className="text-blue-600" />, path: "/admin/site/testimonial" },
        { title: "Newsletter", icon: <Mail size={18} className="text-blue-600" />, path: "/admin/site/newsletter" },
        { title: "Discount Bar", icon: <Tag size={18} className="text-blue-600" />, path: "/admin/site/stickdiscountbar" },
      ],
    },
    {
    ...
    },
    {
      ...
      subLinks: [
        ...
        { title: "List Test", icon: <TestTube size={18} className="text-blue-600" />, path: "/admin/package/test" },
        { title: "Create Parameter", icon: <FlaskConical size={18} className="text-blue-600" />, path: "/admin/package/parameter" },
        {
    ...
    },
    {
      ...
      subLinks: [
        { title: "Add new", icon: <UserPlusIcon size={18} className="text-blue-600" />, path: "/admin/service/new" },
        { title: "Provider List", icon: <Users size={18} className="text-blue-600" />, path: "/admin/service/list" },
      ],
    },
    {
    ...
    },
    {
      ...
      icon: <Scan size={20} className="text-blue-600" />,
      mainPath: "/admin/scan",
      subLinks: [{ title: "Manage Scan", icon: <Scan size={18} className="text-blue-600" />, path: "/admin/scan/new" }],
    },
    {
